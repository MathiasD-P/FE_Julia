...
mutable struct parameters
    ...
    function parameters(;
                     ...
                     new(pdetype, dim, dgtype, bnodes, qnodes, fnodes, enodes, refelem, domain, Neldim, numfluxtype, ICname, BCname, ODE_solver, Nsteps, dt, save, calc_entropy, OOAtest, Nrefinements, gamma,a)
    end
end
